...
# 20 labeled points and 158 unlabeled points 178 in total
nb_samples = X.shape[0]
nb_labeled = 20
nb_unlabled = nb_samples - nb_labeled

nb_unlabeled_samples = 2
feature_cut = 7

X_unlabeled = X[-nb_unlabled:]
